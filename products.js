...
const PRODUCTS = {
  pro_export:  { title: 'BRADAR PRO — контакты и сообщения', description: 'Реальные контакты каналов (@админ по рекламе) + готовые сообщения для размещения + экспорт медиаплана. Доступ на 30 дней ко всем подборам.', stars: 400, days: 30 },
