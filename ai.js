...
async function classify(input) {
  ...
  const user = [
    ...
    '— «детская одежда» → мамы (платят они) → мамы, родительство, семейный досуг (а НЕ «магазины детской одежды»)',
    '— «детейлинг авто» → автовладельцы и автолюбители → авто, тюнинг, автоблоги',
    '— «SaaS для ресторанов» → владельцы ресторанов → ресторанный бизнес, HoReCa, общепит',
    '— «премиум-недвижимость» → состоятельные покупатели → бизнес, premium lifestyle, инвестиции',
    ...
    '• Не путай канал ПРО профессию/товар (там сидят коллеги-конкуренты) с каналом их КЛИЕНТОВ. «Маникюр»/«барбершоп» как канал = мастера; клиенты сидят в женских/мужских lifestyle и локальных пабликах.',
    '• Не давай слова-магниты («бизнес», «новости», «лайфстайл», «саморазвитие») в одиночку — они тянут гигантские нерелевантные каналы. Уточняй нишу.',
    '• Не ищи по названию самого продукта/бренда, если там сидят не покупатели.',
    '• Для локального бизнеса (город указан) — только каналы этого города, без национальных тем.',
    'Теперь для шагов 3–4 работай по профессиональной КАРТЕ ГИПОТЕЗ медиабайера. Не ограничивайся прямой темой — пройди кластеры и выбери 2–4 самых сильных под ЭТОГО покупателя, из них дай фразы:',
    '  1) Прямая категория (приоритет высокий) — где уже читают про сам продукт/категорию.',
    '  2) Проблема/задача (высокий) — где ищут решение боли, которую снимает продукт («как …», симптом, задача).',
    '  3) Смежные интересы (средний) — комплементарные хобби/покупки этой же аудитории (премиум-часы → мужской стиль, авто, luxury; крафтовое пиво → бары, музыка).',
    '  4) Профессия/роль (средний) — если платит специалист/бизнес: должности, отрасль, профсообщества.',
    '  5) Стиль жизни/ценности (средний) — образ жизни и эстетика аудитории (авторские lifestyle-каналы).',
    '  6) География (высокий, если локальный бизнес/доставка) — город, район, городские паблики и афиша.',
    '  7) Конкуренты/альтернативы (средний) — смежные решения той же боли (НЕ прямые конкуренты, где сидят коллеги).',
    '  8) Сезон/событие (низкий) — если спрос сезонный, повод/событие.',
    'Реклама лучше заходит в АВТОРСКИХ каналах и живых тематических сообществах (доверие), хуже — в гигантских обезличенных новостниках-агрегаторах и накрученных каналах.',
    'Дай смесь: 2–3 фразы под ядро (прямая категория/проблема) и 1–2 под смежные кластеры (интересы/профессия/стиль жизни), где покупатель тоже проводит время.',
    ...
    'Определи МОДЕЛЬ ОХВАТА (reachModel). Ключевой вопрос: аудитория ГОТОВА ехать ради продукта, или покупает только потому что рядом с домом?',
    '• "local_point" — рядовая услуга у дома, куда далеко НЕ поедут (барбершоп, продукты, маникюр, районное кафе, химчистка): покупатель = ЖИТЕЛИ этого города/района; общегородские каналы мегаполиса не подходят.',
    '• "delivery" — доставка/выезд в пределах района: каналы города и соседних ЖК зоны доставки.',
    '• "area" — активность/впечатление/услуга, ради которой ЕДУТ по городу/региону (походы, экскурсии, конный клуб, верёвочный парк, загородная база, картинг, мастер-класс, спортшкола): аудитория = сообщество по ИНТЕРЕСУ (туризм, outdoor, хобби) в масштабе региона, а не только жители точки → важна ТЕМА, тематические каналы нужны.',
    '• "high_ticket" — дорогая услуга/покупка, за которой готовы ехать (клиника, стоматология-импланты, авто, недвижимость): можно и тематические каналы большого города, если аудитория точная.',
    ...
    'Правило: рядовая услуга у дома → "local_point". Если ради продукта ЕДУТ (впечатление, интерес, хобби, высокий чек) → "area"/"high_ticket", и тогда ТЕМА/интерес важнее адреса. Нет города / национальный / онлайн → "online".',
